...
Compile example:
    ...
    $env:PATH = "C:\Qt\Qt-5.15-debug-and-release\bin;" + $env:PATH
    git clone -b testing https://github.com/danields966/qt-experiments.git
